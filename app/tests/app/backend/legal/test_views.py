...
class LegalViewsTests(TestCase):
    ...
    def test_privacy(self):
        ...
        data = ['Privacy Policy', 'we collect', 'What do you do',
                'information secure', 'about cookies', 'any question']
    ...
    def test_terms(self):
        ...
        data = ['Terms of Use', 'General Information', 'Copyright and Trademark Notice', 'External Links',
                'Membership Eligibility', 'Fees and Services', 'No Warranty', 'Liability Limit', 'Jurisdiction',
                'Revisions', 'Privacy Policy', 'Personal Information']
        self.assertEqual(response.status_code, 200)
        self.assertTrue(all([x.encode() in response.content for x in data]))

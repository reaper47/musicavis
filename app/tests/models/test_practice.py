...
class PracticeModelTests(TestCase):
    ...
    def test_models_equality_name_property(self):
        ...
        an_improvement, other_improvement = (
            Improvement(name="an improvement"),
            Improvement(name="an improvement"),
        )
        a_positive, other_positive = (
            Positive(name="a positive"),
            Positive(name="a positive"),
        )
    ...
    def test_format_total_practice_time(self):
        ...
        """
        exercises = [
            Exercise(name=chr(ord("A") + i), bpm_start=i, bpm_end=i, minutes=25)
            for i in range(5)
        ]
    ...
    def test_update_model_new_practice(self):
        ...
        new_practice = PracticeDTO(
            ...
            [
                Exercise(
                    name=dtos.AN_EXERCISE,
                    bpm_start=dtos.A_BPM,
                    bpm_end=dtos.A_BPM,
                    minutes=dtos.SOME_MINUTES,
                )
            ],
    ...
    def test_models_to_string(self):
        ...
        models = [
            (practice, f"#{practice.pk} - {practice.date}"),
    ...
    def test_total_practice_time(self):
        ...
        for name, start, end, min in exercises:
            exercise = Exercise.objects.create(
                name=name, bpm_start=start, bpm_end=end, minutes=min
            )

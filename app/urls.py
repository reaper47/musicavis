...
from app.backend.auth.views import (
    login_view,
    signup_view,
    account_confirm,
    resend_account_confirm,
    logout_view,
    password_reset_view,
    request_password_reset_view,
    unsubscribe_view,
)
from app.backend.main.views import (
    index_view,
    sitemap_view,
    notifications_route,
    download_file_route,
...
from app.backend.profile.views import (
    ...
    settings_view,
    settings_access_view,
    settings_profile_view,
    settings_practice_view,
...
urlpatterns = [
    ...
    path(
        "add-new-instrument/",
        add_new_instrument_view,
        name="profile.add_new_instrument",
    ),
    ...
    path(
        "practice/list/", list_past_practices_view, name="practice.list_past_practices"
    ),
]
